<template>
    <div class="container">
      <h1>My Private Recipes</h1>
      <div id="favorite_main_div">
        <RecipePreviewList class="Favorite center" id="RecipePreviewList" title="My Private Recipes" source="personal" />
      </div>
    </div>
  </template>
